...
local identifier = std.strReplace(appId, '-staging', '');
...

{
  ...
  app: tinypad.appContainer(appCpu, appMemory, identifier) {
    env+: {
      DATABASE_URL: tinypad.databaseUrl(identifier, identifier + '_staging'),
      SECRET_KEY_BASE: provide('secret_key_base_staging'),
    },
  },
